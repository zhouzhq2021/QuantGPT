import { FlaskConical, Layers, BarChart3, LayoutDashboard, Star } from "lucide-react";

export type MainTab = "backtest" | "composite" | "comparison" | "dashboard" | "factors";
...
export const TABS: { id: MainTab; label: string; icon: typeof FlaskConical; color: string }[] = [
  ...
  { id: "factors", label: "因子库", icon: Star, color: "amber" },
];
